...
Miku.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let WAuserName = num
                mikutext = `
*السلام عليكم ورحمة لله وبركاته يا*⚡
 @${WAuserName.split("@")[0]},

*نورت أنا البوتة نويل مرحبا بك في مجموعة 🫧☃️ :*
 ${metadata.subject}.

*لو بدك أوامري أكتب 《-الاوامر》 أتمنى لك يوما سعيدا يا أيها   المغامر/ة* 🔱🤍


*اتمني لك إقامه جيده بهذه المجموعه وتذكر أني هنا دائما من أجلك وأن العالم لا يقدر نعمة وجودك وأن لكل بداية نهاية وليس من الضروري أن تكون نهاية حزينة أنت من يجب عليه جعلها سعيدة🫶🏻♥️*
...
Miku.sendMessage(anu.id, buttonMessage)
                	...
                	let WAuserName = num
                    mikutext = `
الا لقاء أيها الغامر/ة شجاع/ة⚡👋,
 @${WAuserName.split("@")[0]},

مع السلامه اللي يطلع يجي غيره
, واللي بعنا خسر دلعنا😂💔!
`
